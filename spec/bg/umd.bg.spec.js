...
// I need to set a local require here to use it. But in normal workflow I don't have to
// because all module code are wrapped and require function is passed in.
var require = umd.require;
...
describe("umd", function() {
    it("should allow environment still be determined as browser global", function() {
